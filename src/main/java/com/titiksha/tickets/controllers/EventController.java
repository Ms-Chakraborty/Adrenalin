...
import static com.titiksha.tickets.util.JwtUtil.parseUserId;
...
import com.titiksha.tickets.mappers.EventMapper;
...
public class EventController {
  ...
  public ResponseEntity<CreateEventResponseDto> createEvent(
    ...
    Events createdEvent = eventService.createEvent(userId, createEventRequest);
  ...
  public ResponseEntity<UpdateEventResponseDto> updateEvent(
    ...
    Events updatedEvent = eventService.updateEventForOrganizer(
  ...
  public ResponseEntity<Page<ListEventResponseDto>> listEvents(
    ...
    UUID userId = parseUserId(jwt);
    Page<Events> events = eventService.listEventsForOrganizer(userId, pageable);
