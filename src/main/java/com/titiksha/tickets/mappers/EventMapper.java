...
public interface EventMapper {
  ...
  CreateEventResponseDto toDto(Events event);

  ListEventTicketTypeResponseDto toDto(TicketType ticketType);

  ListEventResponseDto toListEventResponseDto(Events event);

    GetEventDetailsTicketTypesResponseDto toGetEventDetailsTicketTypesResponseDto(
      TicketType ticketType);

    GetEventDetailsResponseDto toGetEventDetailsResponseDto(Events event);
  ...
  UpdateEventResponseDto toUpdateEventResponseDto(Events event);

  ListPublishedEventResponseDto toListPublishedEventResponseDto(Events event);

  GetPublishedEventDetailsTicketTypesResponseDto toGetPublishedEventDetailsTicketTypesResponseDto(
      TicketType ticketType);

  GetPublishedEventDetailsResponseDto toGetPublishedEventDetailsResponseDto(Events event);
}
